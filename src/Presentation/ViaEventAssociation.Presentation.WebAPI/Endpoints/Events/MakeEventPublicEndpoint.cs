...
[Route("api/events/{eventId:guid}/public")]
public sealed class MakeEventPublicEndpoint(IDispatcher dispatcher)
    : ApiEndpointWithoutRequest<object>
{
    ...
    public override async Task<ActionResult<object>> HandleAsync()
        => await CommandEndpoint.DispatchAsync(this, dispatcher,
            MakeEventPublicCommand.Create(RouteValueReader.Guid(this, "eventId")));
}
