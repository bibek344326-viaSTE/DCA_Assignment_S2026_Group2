...
public class UpdateTimeTests
{
    ...
    [InlineData("2027/08/25 12:00", "2027/08/25 16:30")]
    [InlineData("2027/08/25 08:00", "2027/08/25 12:15")]
    [InlineData("2027/08/25 10:00", "2027/08/25 20:00")]
    [InlineData("2027/08/25 13:00", "2027/08/25 23:00")]
    ...
    [Theory]
    [InlineData("2027/08/25 19:00", "2027/08/26 01:00")]
    [InlineData("2027/08/25 12:00", "2027/08/25 16:30")]
    [InlineData("2027/08/25 08:00", "2027/08/25 12:15")]
    ...
    [InlineData("2027/08/26 19:00", "2027/08/25 23:59")]
    [InlineData("2027/08/27 12:00", "2027/08/25 16:30")]
    [InlineData("2027/08/01 08:00", "2027/07/31 12:15")]
    ...
    // ID:UC4:F2
    [Theory]
    [InlineData("2027/08/26 19:00", "2027/08/26 14:00")]
    [InlineData("2027/08/26 16:00", "2027/08/26 00:00")]
    [InlineData("2027/08/26 19:00", "2027/08/26 18:59")]
    [InlineData("2027/08/26 12:00", "2027/08/26 10:10")]
    [InlineData("2027/08/26 08:00", "2027/08/26 00:30")]
    ...
    [Theory]
    [InlineData("2027/08/26 14:00", "2027/08/26 14:50")]
    [InlineData("2027/08/26 18:00", "2027/08/26 18:59")]
    [InlineData("2027/08/26 12:00", "2027/08/26 12:30")]
    [InlineData("2027/08/26 08:00", "2027/08/26 08:00")]
    ...
    //ID:UC4.F4
    [Theory]
    [InlineData("2027/08/25 23:30", "2027/08/26 00:15")]
    [InlineData("2027/08/30 23:01", "2027/08/31 00:00")]
    [InlineData("2027/08/30 23:59", "2027/08/31 00:01")]
    ...
    //ID:UC4.F5
    [Theory]
    [InlineData("2027/08/25 07:50", "2027/08/25 14:00")]
    [InlineData("2027/08/25 07:59", "2027/08/25 15:00")]
    [InlineData("2027/08/25 01:01", "2027/08/25 08:30")]
    [InlineData("2027/08/25 05:59", "2027/08/25 07:59")]
    [InlineData("2027/08/25 00:59", "2027/08/25 07:59")]
    public void UpdateTime_StartTimeBefore8_FailureMessageReturned(DateTime startTime, DateTime endTime)
    {
        ...
        Assert.Contains(
            ...
            e => e == Error.InvalidStartDateTime || e == Error.InvalidEndDateTime
        );
    }
    
    //ID:UC4.F6
    [Theory]
    [InlineData("2027/08/24 22:00", "2027/08/25 07:59")]
    [InlineData("2027/08/30 23:00", "2027/08/31 02:30")]
    [InlineData("2027/08/24 23:50", "2027/08/25 01:01")]
    ...
    public void UpdateTime_EventInActiveStatus_FailureMessageReturned()
    {
        ...
        var validStartTime = DateTime.Parse("2027/08/25 19:00");
        var validEndTime = DateTime.Parse("2027/08/25 23:59");
    ...
    //ID:UC4.F9
    [Theory]
    [InlineData("2027/08/30 08:00", "2027/08/30 18:01")]
    [InlineData("2027/08/30 14:59", "2027/08/31 01:00")]
    [InlineData("2027/08/30 14:00", "2027/08/31 00:01")]
    [InlineData("2027/08/30 14:00", "2027/08/31 18:30")]
    ...
    public void UpdateTime_StartTimeIsInPast_FailureMessageReturned()
    {
        // Arrange
        var evt = EventFactory.Init().Build();
        var validStartTime = DateTime.Now.AddDays(-1).Date.AddHours(19);
        var validEndTime = validStartTime.AddHours(2);
    ...
    //ID:UC4.F11
    [Theory]
    [InlineData("2027/08/31 00:30", "2027/08/31 08:30")]
    [InlineData("2027/08/30 23:59", "2027/08/31 08:01")]
    [InlineData("2027/08/31 01:00", "2027/08/31 08:00")]
