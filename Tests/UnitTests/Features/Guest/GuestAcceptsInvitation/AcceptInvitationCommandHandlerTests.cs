...
{
    [Fact]
    public async Task HandleAsync_PendingInvitation_AddsParticipant_AndSaves()
    {
        ...
        var handler = new AcceptInvitationCommandHandler(eventRepository, guestRepository, uow);
